...
public:
    ...
    bool solve()
    {
    	switch(solver_type)
    	{
    		...
    		case GSCUDA: return solveGSCUDA();
    		default: return false;
    	}
    }

    //copies potential from GPU to the CPU for plotting
    void updateHostPhi();
...
protected:
	...
	dim3 threads_per_block3;
	dim3 num_blocks3;
	devSeptaD *devA,*dev_devA;
	double *dev_phi, *dev_b;
	double *dev_res;
	double *phi,*b;
	double *res_pinned;
