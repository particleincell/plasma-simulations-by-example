...
void Output::fields(World &world, vector<Species> &species)
{
	...
	/*potential, scalar*/
	out<<"<DataArray Name=\"phi_m_theory\" NumberOfComponents=\"1\" format=\"ascii\" type=\"Float64\">\n";
	out<<world.phi_m_theory;
	out<<"</DataArray>\n";

	/*magnetic field, 3 component vector*/
	out<<"<DataArray Name=\"B\" NumberOfComponents=\"3\" format=\"ascii\" type=\"Float64\">\n";
	out<<world.B;
	out<<"</DataArray>\n";

	out<<"<DataArray Name=\"H\" NumberOfComponents=\"3\" format=\"ascii\" type=\"Float64\">\n";
	out<<world.H;
	out<<"</DataArray>\n";

	/*magnetization, 3 component vector*/
