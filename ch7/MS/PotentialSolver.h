...
public:
	...
	bool static solveGSLinear(Matrix &A, dvector &x, dvector &b, int max_it, double tolerance);

	//computes negative gradient of vector f
	void static computeNegGradient(Field3 &grad, const dvector &f, const World &world);
