...
public:	
	...
	double3 getSphereOrig() {return sphere_x0;}
	double getSphereRad() {return sqrt(sphere_rad2);}

	/*adds uniform magnetization on sphere internal nodes*/
	void magnetizeSphere(const double3& M0);
	...
	Field phi_m_theory;	//analytical solution from Jackson
