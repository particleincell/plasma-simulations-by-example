...
void Output::fields(World &world, vector<Species> &species)
{
	...
	for (Species &sp:species)
	{
		out<<"<DataArray Name=\"j."<<sp.name<<"\" NumberOfComponents=\"3\" format=\"ascii\" type=\"Float64\">\n";
		out<<sp.j;
		out<<"</DataArray>\n";
	}
	...
	out<<"<DataArray Name=\"E\" NumberOfComponents=\"3\" format=\"ascii\" type=\"Float64\">\n";
	out<<world.E;
	out<<"</DataArray>\n";

	/*electric field, 3 component vector*/
	out<<"<DataArray Name=\"j_tot\" NumberOfComponents=\"3\" format=\"ascii\" type=\"Float64\">\n";
	out<<world.j;
	out<<"</DataArray>\n";

	/*electric field, 3 component vector*/
	out<<"<DataArray Name=\"M\" NumberOfComponents=\"3\" format=\"ascii\" type=\"Float64\">\n";
	out<<world.M;
	out<<"</DataArray>\n";

	/*magnetic potential, scalar*/
	out<<"<DataArray Name=\"phi_m\" NumberOfComponents=\"1\" format=\"ascii\" type=\"Float64\">\n";
	out<<world.phi_m;
	out<<"</DataArray>\n";

	/*magnetic potential, scalar*/
	out<<"<DataArray Name=\"b_m\" NumberOfComponents=\"1\" format=\"ascii\" type=\"Float64\">\n";
	out<<world.b_m;
	out<<"</DataArray>\n";
	...
	out<<"<CellData>\n";
	/*mag field, 3 component vector*/
	out<<"<DataArray Name=\"B\" NumberOfComponents=\"3\" format=\"ascii\" type=\"Float64\">\n";
	out<<world.B;
	out<<"</DataArray>\n";
	out<<"</CellData>\n";
